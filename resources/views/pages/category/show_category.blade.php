    ...
    <div class="col-md-4 style">
        ...
        <form action="">
            ...
            <select name="sort" id="sort" class="form-control">
                ...
                <option value="{{Request::url()}}?sort_by=kytu_az">---lọc ký tự A Đến Z---</option>
                <option value="{{Request::url()}}?sort_by=kytu_za">--- lọc ký tự Z Đến A---</option>
            </select>
  ...
  .modal-lg{
    width: 1200px;
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary redirect-cart">Chi tiết sản phẩm</button>
        </div>
      </div>
    </div>
  </div>
